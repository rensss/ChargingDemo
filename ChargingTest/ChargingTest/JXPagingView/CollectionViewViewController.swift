...
class CollectionViewViewController: UIViewController {
    lazy var rootPagingView: JXPagingView = JXPagingView(delegate: self)
    ...
    var titles = ["能力", "爱好", "队友", "能力", "爱好", "队友", "能力", "爱好", "队友", "能力", "爱好", "队友"]
    ...
    override func viewDidLoad() {
        ...
        self.view.addSubview(rootPagingView)
        
//        segmentedView.listContainer = rootPagingView.listContainerView
//        segmentedView.listContainer = pagingView.listContainerView

        //扣边返回处理，下面的代码要加上
        rootPagingView.listContainerView.scrollView.panGestureRecognizer.require(toFail: self.navigationController!.interactivePopGestureRecognizer!)
        rootPagingView.mainTableView.panGestureRecognizer.require(toFail: self.navigationController!.interactivePopGestureRecognizer!)
    ...
    override func viewDidLayoutSubviews() {
        ...
        rootPagingView.frame = self.view.bounds
    }
