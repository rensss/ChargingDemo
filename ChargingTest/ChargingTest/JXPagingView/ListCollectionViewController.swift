...
class ListCollectionViewController: UIViewController {
    ...
    var scrollViewCallback: ((UIScrollView) -> Void)?
    ...
    override func viewDidLoad() {
        ...
        collectionView.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: UIWindow.xnKeyWindow()?.safeAreaInsets.bottom ?? 0, right: 0)
...
extension ListCollectionViewController: JXPagingViewListViewDelegate {
    ...
    func listViewDidScrollCallback(callback: @escaping (UIScrollView) -> ()) {
        self.scrollViewCallback = callback
    }
